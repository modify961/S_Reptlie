<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reptile_wb.aspx.cs" Inherits="reptile_wb" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table>
                ...
                <tr>
                    <td class="td_right">是否使用缓存：</td>
                    <td>
                        <asp:DropDownList ID="dp_cacheCookie" runat="server" CssClass="input_len">
                            <asp:ListItem Value="0" Selected="True">否</asp:ListItem>
                            <asp:ListItem Value="1">是</asp:ListItem>
                        </asp:DropDownList>
                    </td>
